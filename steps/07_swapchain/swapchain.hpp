...
struct swapchain_bundle
{
    ...
    swapchain_bundle (vk::raii::Device &l_device, vk::SwapchainCreateInfoKHR &create_info)
        : m_impl {l_device.createSwapchainKHR (create_info)}, m_images {(*l_device).getSwapchainImagesKHR (*m_impl)},
          m_format {create_info.imageFormat}, m_extent {create_info.imageExtent}
    {
    }
